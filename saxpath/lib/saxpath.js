...
var XPathParser = require('saxpath/lib/xpath_parser');
var XmlRecorder = require('saxpath/lib/xml_recorder');

var StartState            = require('saxpath/lib/start_state');
var ChildState            = require('saxpath/lib/child_state');
var SelfOrDescendantState = require('saxpath/lib/self_or_descendant_state');
