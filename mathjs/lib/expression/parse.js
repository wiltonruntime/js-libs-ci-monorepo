...
function factory (type, config, load, typed) {
  var numeric = load(require('mathjs/lib/type/numeric'));

  var AccessorNode            = load(require('mathjs/lib/expression/node/AccessorNode'));
  var ArrayNode               = load(require('mathjs/lib/expression/node/ArrayNode'));
  var AssignmentNode          = load(require('mathjs/lib/expression/node/AssignmentNode'));
  var BlockNode               = load(require('mathjs/lib/expression/node/BlockNode'));
  var ConditionalNode         = load(require('mathjs/lib/expression/node/ConditionalNode'));
  var ConstantNode            = load(require('mathjs/lib/expression/node/ConstantNode'));
  var FunctionAssignmentNode  = load(require('mathjs/lib/expression/node/FunctionAssignmentNode'));
  var IndexNode               = load(require('mathjs/lib/expression/node/IndexNode'));
  var ObjectNode              = load(require('mathjs/lib/expression/node/ObjectNode'));
  var OperatorNode            = load(require('mathjs/lib/expression/node/OperatorNode'));
  var ParenthesisNode         = load(require('mathjs/lib/expression/node/ParenthesisNode'));
  var FunctionNode            = load(require('mathjs/lib/expression/node/FunctionNode'));
  var RangeNode               = load(require('mathjs/lib/expression/node/RangeNode'));
