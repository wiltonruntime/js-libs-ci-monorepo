...
function factory (type, config, load, typed) {
  ...
  var assign = load(require('mathjs/lib/expression/node/utils/assign'));
  var access = load(require('mathjs/lib/expression/node/utils/access'));

  var operators = require('mathjs/lib/expression/operators');
