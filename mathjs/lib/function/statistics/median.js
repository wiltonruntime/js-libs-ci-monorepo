...
function factory (type, config, load, typed) {
  ...
  var compare = load(require('mathjs/lib/function/relational/compare'));
  var partitionSelect = load(require('mathjs/lib/function/matrix/partitionSelect'));
  var improveErrorMessage = load(require('mathjs/lib/function/statistics/utils/improveErrorMessage'));
