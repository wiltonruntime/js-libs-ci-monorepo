...
function factory (type, config, load, typed) {
  ...
  var ArgumentsError = require('mathjs/lib/error/ArgumentsError');
  var parse = load(require('mathjs/lib/expression/function/parse'));
  var number = require('mathjs/lib/utils/number')
