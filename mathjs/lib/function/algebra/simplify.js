...
function factory (type, config, load, typed, math) {
  ...
  var Node = load(require('mathjs/lib/expression/node/Node'));
  var simplifyConstant = load(require('mathjs/lib/function/algebra/simplify/simplifyConstant'));
  var simplifyCore = load(require('mathjs/lib/function/algebra/simplify/simplifyCore'));
  var resolve = load(require('mathjs/lib/function/algebra/simplify/resolve'));

  var util = load(require('mathjs/lib/function/algebra/simplify/util'));
