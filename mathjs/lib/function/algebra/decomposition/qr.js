...
function factory (type, config, load, typed) {
  ...
  var zeros = load(require('mathjs/lib/function/matrix/zeros'));
  var eye = load(require('mathjs/lib/function/matrix/eye'));
  var clone = load(require('mathjs/lib/function/utils/clone'));
  
  var isZero = load(require('mathjs/lib/function/utils/isZero'));
  var isPositive = load(require('mathjs/lib/function/utils/isPositive'));
  var unequal = load(require('mathjs/lib/function/relational/unequal'));
    
  var abs = load(require('mathjs/lib/function/arithmetic/abs'));
  var sign = load(require('mathjs/lib/function/arithmetic/sign'));
  var sqrt = load(require('mathjs/lib/function/arithmetic/sqrt'));
  var conj = load(require('mathjs/lib/function/complex/conj'));
  
  var unaryMinus = load(require('mathjs/lib/function/arithmetic/unaryMinus')); 
  var addScalar = load(require('mathjs/lib/function/arithmetic/addScalar'));  
  var divideScalar = load(require('mathjs/lib/function/arithmetic/divideScalar'));
  var multiplyScalar = load(require('mathjs/lib/function/arithmetic/multiplyScalar'));  
