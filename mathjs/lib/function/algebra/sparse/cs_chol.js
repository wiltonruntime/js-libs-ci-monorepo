...
function factory (type, config, load) {
  ...
  var im = load(require('mathjs/lib/complex/im'));
  var re = load(require('mathjs/lib/complex/re'));
  var conj = load(require('mathjs/lib/complex/conj'));
  var equal = load(require('mathjs/lib/function/relational/equal'));
  var smallerEq = load(require('mathjs/lib/function/relational/smallerEq'));

  var cs_symperm = load(require('mathjs/lib/function/algebra/sparse/cs_symperm'));
  var cs_ereach  = load(require('mathjs/lib/function/algebra/sparse/cs_ereach'));
