...
function factory (type, config, load, typed) {
  ...
  var algorithm01 = load(require('mathjs/lib/type/matrix/utils/algorithm01'));
  var algorithm02 = load(require('mathjs/lib/type/matrix/utils/algorithm02'));
  var algorithm08 = load(require('mathjs/lib/type/matrix/utils/algorithm08'));
  var algorithm10 = load(require('mathjs/lib/type/matrix/utils/algorithm10'));
