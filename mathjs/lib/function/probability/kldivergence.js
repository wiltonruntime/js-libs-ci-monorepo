...
function factory(type, config, load, typed) {
    ...
    var sum = load(require('mathjs/lib/function/statistics/sum'));
    var multiply = load(require('mathjs/lib/function/arithmetic/multiply'));
    var dotDivide = load(require('mathjs/lib/function/arithmetic/dotDivide'));
    var log = load(require('mathjs/lib/function/arithmetic/log'));
