...
function factory (type, config, load, typed, math) {
  ...
  var fix       = load(require('mathjs/lib/function/arithmetic/fix'));
  var round     = load(require('mathjs/lib/function/arithmetic/round'));
  var equal     = load(require('mathjs/lib/function/relational/equal'));
  var isNumeric = load(require('mathjs/lib/function/utils/isNumeric'));
  var format    = load(require('mathjs/lib/function/string/format'));
  var getTypeOf = load(require('mathjs/lib/function/utils/typeof'));
  var toNumber  = load(require('mathjs/lib/type/number'));
  var Complex   = load(require('mathjs/lib/type/complex/Complex'));
