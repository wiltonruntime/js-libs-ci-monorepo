...
define([
    ...
    // image from file
    fs.writeFile(dir + "test.png", pngDataInHex, {hex: true});
    doc.drawImage({
        imagePath: dir + "test.png",
        imageFormat: "PNG",
        x: 300,
        y: 300,
        width: 256,
    ...
    assert.throws(function() {
        docJpeg1.drawImage({
            imageHex: jpegDataInHex.substr(0, 2),
            imageFormat: "JPEG",
            x: 50,
            y: 500,
            width: 256,
    ...
    assert.throws(function() {
        docJpeg3.drawImage({
            imageHex: jpegDataInHex.replace(/0100063f0/, "fffffffff"),
            imageFormat: "JPEG",
            x: 50,
            y: 500,
            width: 256,
